...
export type UiCommand = UiGetStateCommand | UiSetParameterCommand | UiLoadPresetCommand | UiSavePresetCommand | UiUiReadyCommand | UiSubscribeTelemetryCommand | UiGetTelemetryCommand | UiGetTelemetrySourcesCommand | UiGetModMetadataCommand | UiPatchbayUpdateCommand | UiGetScopeStateCommand | UiSetScopeStateCommand | UiExitCommand | UiNewPresetCommand | UiSetSystemSettingCommand | UiServiceActionCommand | {
    type: 'getMetadata';
    payload: {};
} | {
...
export type RpcResponse = StateResponse | ParamAckResponse | TelemetryDataResponse | TelemetrySourcesResponse | ModMetadataResponse | PatchbayUpdateAckResponse | RpcEnvelope<boolean> | RpcEnvelope<Record<string, unknown>> | RpcEnvelope<unknown[]> | RpcErrorEnvelope | RpcEnvelope;
export type BridgeMessage = UiCommand | RpcResponse | UiEvent;
export declare function isRpcEnvelope(value: unknown): value is RpcEnvelope;
export declare function isUiEvent(value: unknown): value is UiEvent;
export declare function isParamChangeEvent(value: unknown): value is ParamChangeEvent;
export declare function isStateUpdateEvent(value: unknown): value is StateUpdateEvent;
export declare function isTelemetryUpdateEvent(value: unknown): value is TelemetryUpdateEvent;
export declare function normalizeIncomingEvent(value: unknown): UiEvent | RpcResponse | null;
