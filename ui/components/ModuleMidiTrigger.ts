...
export class ModuleMidiTrigger {
    ...
    private currentNote: number = 0; // index in ["C", ...]
    ...
    private bind(): void {
        const noteSel = this.content.querySelector('#trigger-note') as HTMLSelectElement;
        const octSel = this.content.querySelector('#trigger-octave') as HTMLSelectElement;
        const fireBtn = this.content.querySelector('#big-fire-btn') as HTMLElement;
