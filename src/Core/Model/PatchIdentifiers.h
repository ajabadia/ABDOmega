...
namespace Model {
    ...
    inline ModuleTypeId mapIdToType(const std::string& id) {
        ...
        if (id == "osc_va_basic")      return ModuleTypeId::VaOscillator;
        if (id == "flt_juno_ir3109")   return ModuleTypeId::JunoFilter;
        if (id == "flt_jp_8000")       return ModuleTypeId::JpFilter;
        if (id == "flt_korg_35")       return ModuleTypeId::KorgFilter;
        if (id == "env_adsr_va")       return ModuleTypeId::EnvelopeAdsr;
        if (id == "lfo_va_basic")      return ModuleTypeId::LfoVA;
        if (id == "fx_delay_modern")   return ModuleTypeId::MasterDelay;
